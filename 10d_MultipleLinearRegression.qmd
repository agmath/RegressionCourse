...
Finally, our *residual standard error* has also changed slightly. We now expect our typical prediction error to be on the order of `r mass_multi_fit %>% glance() %>% pull(sigma)`g.
