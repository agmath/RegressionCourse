...
$$\begin{align}\mathbb{E}\left[\text{body_mass_g}\right] \approx &117741.35 + 45.69\left(\text{bill_length_mm}\right) + 116.34\left(\text{bill_depth_mm}\right) +\\ &24.73\left(\text{flipper_length_mm}\right) - 61.07\left(\text{year}\right) - 611.87\left(\text{species_Chinstrap}\right) +\\ &674.46\left(\text{species_Gentoo}\right)\end{align}$$
