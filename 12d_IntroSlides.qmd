...
2. Open the notebook which includes your models for used car prices
...
1. Identify a categorical predictor of price in your used cars data set
...
1. Choose one categorical predictor of price for a used car in your dataset
...
2. Set up a linear regression model which uses your chosen categorical variable as the sole predictor of car price
