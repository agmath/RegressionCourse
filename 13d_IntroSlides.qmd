...
+ continue adding on to the notebook containing your models for used car prices
...
If you're playing along with the used cars data... 
...
Again, if you are playing along with your used cars data...
...
For those still following along with the used cars data...

1. plot your model's fitted values along with the observed selling prices for your training data
...
If you have a model that predicts prices of used cars...
