...
1. Choose two categorical variables and one numerical variable to use in predicting the price of a car
...
1. Choose two numerical predictors of price which might have an interaction effect in determining price of the used cars in your data set
