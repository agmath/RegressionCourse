...
From the plot above, we can see that the *living area* (`Gr_Liv_Area`), *year of construction*, and the number of cars the *garage* is designed to hold were the most important predictors of *selling price*. Before we close this notebook, let's take a look at how well this model predicts the selling prices of homes in our *test* set.
...
This final ensemble of models predicted selling prices of homes with an root mean squared error of \$21,680.86. 
