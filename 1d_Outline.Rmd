...
**About the Competition**: The best way to learn regression is by doing regression. I've created a Kaggle competition that is private for students in our class as well as students in a similar class at another college. You'll be in a friendly competition with your classmates and those students from St. Vincent College in Pennsylvania this semester. Your task is to predict the price of an AirBnB rental in New York City and provide insight into what factors most greatly influence these booking prices. Your goal is to *construct the best performing predictive model* (the scoring metric used is root mean square prediction error on the evaluation set with hidden booking price)
