...
+ The competition will be hosted at Kaggle.
+ The competition is closed to only students in our course.
+ You'll need a free account -- I'll post the link to our competition in Slack.
+ Your grade is **not** linked to where you finish in the competition.
+ The competition aspect is *friendly* -- please do keep it that way.
+ Past students have cited the competition as motivating and a great source of learning -- on of the most valuable parts of the course.
...
+ **Discussion Days** - Most of our meetings...
  ...
  + An five-minute overview of main ideas (slides) followed by/including discussion.
  + We'll work in R to implement the day's main ideas with a data set.
  + You have full, detailed notes on the webpage (use these how you like) -- focus on implementation and experimentation in class.
