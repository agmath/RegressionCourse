...
+ **Competition Assignments:** We'll learn regression by doing regression. We have six assignments associated with a modeling competition on rental times for bicycles in a city bike share program.
+ **Project:** A final course project spanning our last several weeks together.
+ **Debrief Interview:** During the final two weeks of the semester, you'll schedule a 15- to 20-minute meeting with me where we'll discuss some course material and your project. You'll have a practice interview at approximately the midpoint of the semester worth 5% and the final interview will account for 15% of your course grade. I'll provide you with example questions to prepare from.

## Competition?

+ Hosted at Kaggle.
+ Closed to only students in our course and a similar course at St. Vincent College just outside of Pittsburgh, PA.
...
+ Confidence Intervals: $\left(\text{point estimate}\right) \pm 2\cdot \left(\text{standard error}\right)$
  ...
  + We are [XX]% confident that our [parameter] falls between [the lower bound] and [the upper bound].
+ Hypothesis Testing: $p< \alpha$ means data are incompatible with a null (skeptical) hypothesis.

  + Generally this will mean that a model, predictor, or model term, has statistically significant explanatory or predictive value in estimating a response.
