...
**Homework**: Please do the following for homework before our next meeting:
  ...
  + **Optional:** Chapter 2, problems 1, 2, and 4
  + **Required:** Download the `AnalyticsReportShell.rmd` file from our course webpage and open it in RStudio. Use it to complete `Competition Assignment 1`. Check BrightSpace for the due date.
