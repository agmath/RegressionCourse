...
$\bigstar$ Read this `usedCars` dataset into your Quarto Notebook [from this link](https://raw.githubusercontent.com/agmath/agmath.github.io/master/data/classification/cars.csv)
...
> **Note:** This used cars data was uploaded to Kaggle by Sujith K Mandala. The [original dataset can be found here](https://www.kaggle.com/datasets/sujithmandala/second-hand-car-price-prediction).
...
$\bigstar$ Try these functions on your `usedCars` data
...
**Reminder:** You have a fully complete (and documented) notebook using the `mpg` data on the course webpage -- note this data is different than the `usedCars` data you worked with today

. . .

Use this time to continue playing with the `usedCars` pricing data
...
2. Document your work by including text descriptions alongside the code chunks
