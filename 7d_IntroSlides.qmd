...
#| echo: true
#| eval: false
#| code-line-numbers: "|1-2|4-6|8-10|12-14|1-14"
...
lin_reg_rec <- recipe(response ~ pred_1 + pred_2 + ... + pred_k, data = train)
...
To create a single column (`.pred`) data frame of predictions.
...
I prefer the `augment()` method nearly always!
