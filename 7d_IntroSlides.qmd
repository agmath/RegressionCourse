...
4. Read in the `airbnb` data that we've been working with recently
5. Adapt the code on this slide to split your `airbnb` data into `training` and `test` sets.
...
2. Choose one of the available (numeric) predictors of listing price for the `airbnb` rentals in your data set and construct a *recipe* to predict price using that single predictor
