...
+ Horizontal models just predict average response, ignoring all observation-specific features
  ...
  + They assume that having information about features of an observation gives no advantage in predicting its response
...
<font size="120pt"> Hypothesizing, Constructing, Assessing, and Interpreting Simple Linear Regression Models
</font>
