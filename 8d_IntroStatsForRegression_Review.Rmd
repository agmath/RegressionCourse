...
$$\left(point~estimate\right)\pm\left(critical~value\right)\left(standard~error\right)$$
...
$$\left(point~estimate\right)\pm 2\left(standard~error\right)$$
