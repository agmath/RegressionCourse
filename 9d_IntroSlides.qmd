...
3. Open your most recent notebook -- the one where you built a simple linear regressor to predict the price of a used car
4. Run all of the code chunks in that notebook
5. Describe the *inferential* and *predictive* questions you implicitly asked in pursuing the construction of that model
...
<font size="120pt"> Let's try this!</font>

</center>

1. Write down two predictive questions associated with used car prices that could be answered with your model
