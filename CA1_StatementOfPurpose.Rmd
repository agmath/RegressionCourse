...
Navigate to [our competition site at Kaggle](). Either sign in with Facebook, Google, or create an account using an e-mail address.

Click the button to **Join Competition** -- you'll be asked to confirm that you accept the rules (they are to: have fun, be respectful, learn new things, and not to cheat).

Read the information on the various tabs of the competition page to get familiar with the task at hand.

Download the three data sets -- you'll need `data.csv` for this assignment, `comp.csv` contains the actual competition data and will be used once we learn how to construct models, and `sample.csv` just gives you an example of what your submission file should look like when you go to submit predictions for scoring later in our semester.
...
Create a new R Markdown Notebook which will serve as your codebook and analytics report for the competition. You can do this as follows:
...
Once you are done, *knit* your R Markdown document using the blue knit button.
