...
4. Download the three data sets -- you'll need `dataSP23.csv` for this assignment, `compSP23.csv` contains the actual competition data and will be used once we learn how to construct models, and `sampSP23.csv` just gives you an example of what your submission file should look like when you go to submit predictions for scoring later in our semester.
...
5. Download and open the R Markdown version of the `AnalyticsReportShell` in RStudio.
...
6. In that notebook, do the following to load the data.
  ...
  + Use `read_csv()` along with the path to the `dataSP23.csv` file on your computer to read that file into your notebook. Don't forget to store your data into a named variable so that you can continue to access it. 
