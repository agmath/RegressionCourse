...
4. Download the three data sets -- you'll need `dataFA24.csv` for this assignment, `compFA24.csv` contains the actual competition data and will be used once we learn how to construct models, and `sampFA24.csv` just gives you an example of what your submission file should look like when you go to submit predictions for scoring later in our semester.
...
6. In that notebook, do the following to load the data.
  ...
  + Use `read_csv()` along with the path to the `dataFA24.csv` file on your computer to read that file into your notebook. Don't forget to store your data into a named variable so that you can continue to access it. 
